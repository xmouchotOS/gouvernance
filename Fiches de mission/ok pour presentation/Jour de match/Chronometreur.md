# Chronométreur (table de marque)

## Objectif du rôle
Garantir le bon déroulement de la rencontre en assurant le chronométrage (temps de jeu, temps-morts, exclusions), en lien avec les arbitres et la table.
...
- Calme et neutralité
- Connaissance des règles de base (time-out, exclusions, zone de changement)
- Aisance avec un tableau de marque/chronomètre

## Charge estimée
Environ 2 heures par match (installation + rencontre + rangement).
