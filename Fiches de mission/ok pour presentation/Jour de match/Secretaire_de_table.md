# Secrétaire de table (FDME / table de marque)

## Objectif du rôle
Assurer la tenue de la table (FDME/feuille de match) en consignant de façon fiable les événements du match (buteurs, sanctions, exclusions, temps-morts), en lien avec les arbitres.
...
- Aisance avec les outils numériques (FDME) ou la tenue papier
- Connaissance des règles de base (sanctions, exclusions, temps-morts)
- Calme, diplomatie et neutralité

## Charge estimée
Environ 2 heures par match (préparation + rencontre + clôture).
